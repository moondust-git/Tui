...
@Component({
  selector: 'datepicker',
  template: `
    <datepicker-container [activeDate]="activeDate"
      ...
      <daypicker tabindex="0" class="datetimepicker-days"></daypicker>
      <monthpicker tabindex="0" class="datetimepicker-months"></monthpicker>
      <yearpicker tabindex="0" class="datetimepicker-years"></yearpicker>
